...
export class AuthenticationService {
    public token: string;
    public registrationServerUrl:string = 'http://52.35.11.220:8080/service-webapp/api/LogIn';
    public loginServerUrl:string = 'http://52.35.11.220:8080/service-webapp/api/SignUp';
